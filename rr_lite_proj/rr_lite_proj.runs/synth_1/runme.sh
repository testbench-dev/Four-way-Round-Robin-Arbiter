...
HD_PWD='C:/Projects/RR/rr_lite_proj/rr_lite_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rr_arbiter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rr_arbiter.tcl
